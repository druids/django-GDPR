...
class TestIPCrypt(TestCase):
    ...
    def test_ipv4_key_1(self):
        ...
        self.assertEqual(encrypted_ip, '139.111.117.167')
        self.assertEqual(decrypted_ip, clear_ip)
    ...
    def test_ipv4_key_2(self):
        ...
        self.assertEqual(encrypted_ip, '66.235.221.231')
        self.assertEqual(decrypted_ip, clear_ip)
    ...
    def test_ipv4_key_3(self):
        ...
        self.assertEqual(encrypted_ip, '203.253.152.187')
        self.assertEqual(decrypted_ip, clear_ip)
    ...
    def test_ipv6_key_1(self):
        ...
        self.assertEqual(encrypted_ip, 'a551:9cb0:c9b:f6e1:6112:58a:af29:3a6c')
        self.assertEqual(decrypted_ip, clear_ip)
    ...
    def test_ipv6_key_2(self):
        ...
        self.assertEqual(encrypted_ip, '6e60:2674:2fac:d383:f9d5:dcfe:fc53:328e')
        self.assertEqual(decrypted_ip, clear_ip)
    ...
    def test_ipv6_key_3(self):
        ...
        self.assertEqual(encrypted_ip, 'a8f5:16c8:e2ea:23b9:748d:67a2:4107:9d2e')
        self.assertEqual(decrypted_ip, clear_ip)
